package com.example.sanketpatel.e_notes;
...
//                FirebaseStorage mFirebaseStorage = null;
//                StorageReference photoRef = mFirebaseStorage.getReferenceFromUrl(upload.getUrl());
//
                Toast.makeText(ViewUploadsActivity.this,""+upload.getUrl(),Toast.LENGTH_SHORT).show();

                DatabaseReference ref = FirebaseDatabase.getInstance().getReference();
                Query applesQuery = ref.child("uploads").orderByChild("url").equalTo(upload.getUrl());
